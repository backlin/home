...
function RControlMenu()
  ...
  call RCreateMenuItem("nvi", 'Control.whos', '<Plug>RWhos', 'rr', ':call SendCmdToR("whos()")')
...
function RControlMaps()
  ...
  call RCreateMaps("nvi", '<Plug>RWhos',         'rr', ':call SendCmdToR("whos()")<CR>:echon')
...
function MakeRMenu()
  ...
  nmenu ToolBar.RWhos :call SendCmdToR("whos()")<CR>
  imenu ToolBar.RWhos <Esc>:call SendCmdToR("whos()")<CR>
